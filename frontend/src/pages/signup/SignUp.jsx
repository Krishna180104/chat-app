      ...
      <h1 className="text-3xl font-semibold text-center text-gray-300">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label className="label p-2">
            ...
            <input type="text" placeholder='Enter User Name' className='w-full input input-bordered h-10' value={inputs.username} onChange={(e) => setInputs({...inputs,username:e.target.value})}/>
          </div>
